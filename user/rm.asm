  ...
  1f:	7e 07                	jle    28 <main+0x28>
{
  ...
  54:	ff 36                	push   (%esi)
  56:	e8 8e 00 00 00       	call   e9 <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 1ac:	43                   	inc    %ebx
 1ad:	8a 92 e0 03 00 00    	mov    0x3e0(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 26f:	ff 24 85 88 03 00 00 	jmp    *0x388(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 2d4:	75 13                	jne    2e9 <printf+0xf5>
          s = "(null)";
 2d6:	be 81 03 00 00       	mov    $0x381,%esi
